...
export const councils = [
  {
    ...
    titleEn: '2026 1st Student Council LUCID',
    intro:
    ...
    members: [
      { role: '위원장', name: '주현호', nameEn: 'Hyun Ho Ju', majors: '디지털인문예술 22' },
      { role: '부위원장', name: '윤현아', nameEn: 'Hyun A Yoon', majors: '디지털인문예술 23' },
      { role: '기획부', name: '한수빈', nameEn: 'Su Bin Han' },
      { role: '기획부', name: '김소연', nameEn: 'So Yeon Kim' },
      { role: '홍보부', name: '여동규', nameEn: 'Dong Gyu Yeo' },
      { role: '홍보부', name: '김지연', nameEn: 'Ji Yeon Kim' },
      { role: '홍보부', name: '송은채', nameEn: 'Eun Chae Song' },
      { role: '홍보부', name: '정민서', nameEn: 'Min Seo Jeong' },
      { role: '웹전시부', name: '임지우', nameEn: 'Ji Woo Im' },
      { role: '웹전시부', name: '임세연', nameEn: 'Se Yeon Im' },
    ],
  },
  {
    year: 2025,
    ...
    name: 'CUBE',
    title: '제7대 학생회 CUBE',
    titleEn: '2025 7th Student Council CUBE',
    intro:
    ...
    members: [
      { role: '학회장', name: '권서영', nameEn: 'Seo Young Kwon', majors: '디지털인문예술전공' },
      { role: '부학회장', name: '최서연', nameEn: 'Seo Yeon Choi', majors: '디지털인문예술전공' },
      { role: '전시', name: '감주희', nameEn: 'Ju Hee Gam' },
      { role: '전시', name: '강대승', nameEn: 'Dae Seung Kang' },
      { role: '전시', name: '김소연', nameEn: 'So Yeon Kim' },
      { role: '전시', name: '주현호', nameEn: 'Hyun Ho Ju' },
      { role: '대외', name: '김찬민', nameEn: 'Chan Min Kim' },
      { role: '대외', name: '윤현아', nameEn: 'Hyun A Yoon' },
      { role: '홍보', name: '신현서', nameEn: 'Hyun Seo Shin' },
      { role: '홍보', name: '송은채', nameEn: 'Eun Chae Song' },
      { role: '기획', name: '우세희', nameEn: 'Se Hee Woo' },
      { role: '기획', name: '김채린', nameEn: 'Chae Rin Kim' },
    ],
  },
  {
    year: 2024,
    ...
    name: '채움',
    title: '제 6대 학생회 채움',
    titleEn: '2024 6th Student Council Chaeum',
    intro:
    ...
    members: [
      { role: '학회장', name: '송유경', nameEn: 'Yu Kyung Song', majors: '디지털인문예술전공' },
      { role: '부학회장', name: '심재연', nameEn: 'Jae Yeon Sim', majors: '디지털인문예술전공' },
      { role: '홍보', name: '권서영', nameEn: 'Seo Young Kwon', majors: '디지털인문예술전공' },
      { role: '홍보', name: '최도윤', nameEn: 'Do Yoon Choi', majors: '디지털인문예술전공' },
      { role: '디자인', name: '최서연', nameEn: 'Seo Yeon Choi', majors: '디지털인문예술전공' },
      { role: '디자인', name: '이예린', nameEn: 'Ye Rin Lee', majors: '디지털인문예술전공' },
      { role: '기획', name: '정재훈', nameEn: 'Jae Hoon Jeong', majors: '디지털인문예술전공' },
    ],
  },
  {
    year: 2023,
    ...
    name: 'DX',
    title: '제 5대 학생회 DX',
    titleEn: '2023 5th Student Council DX',
    intro:
    ...
    members: [
      { role: '학회장', name: '윤호용', nameEn: 'Ho Yong Yoon', majors: '디지털인문예술 전공 19' },
      { role: '부학회장', name: '원수정', nameEn: 'Su Jeong Won', majors: '디지털인문예술 전공 21' },
      { role: '홍보', name: '정민주', nameEn: 'Min Ju Jeong', majors: '디지털인문예술 전공 22' },
      { role: '총괄', name: '송유경', nameEn: 'Yu Kyung Song', majors: '디지털인문예술 전공 22' },
      { role: '기획', name: '심재연', nameEn: 'Jae Yeon Sim', majors: '디지털인문예술 전공 21' },
      { role: '기획', name: '최선', nameEn: 'Seon Choi', majors: '디지털인문예술 전공 22' },
    ],
  },
  {
    year: 2022,
    ...
    name: 'OPEN',
    title: '제 4대 학생회 OPEN',
    titleEn: '2022 4th Student Council OPEN',
    intro:
    ...
    members: [
      { role: '학회장', name: '곽선재', nameEn: 'Seon Jae Kwak', majors: '디지털인문예술 전공 19' },
      { role: '부학회장', name: '윤숙영', nameEn: 'Suk Young Yoon', majors: '사회학과 19' },
      { role: '기획팀', name: '허민', nameEn: 'Min Heo', majors: '사회학과 19' },
      { role: '홍보팀', name: '김희경', nameEn: 'Hee Kyung Kim', majors: '경영학과 20' },
      { role: '홍보팀', name: '박시영', nameEn: 'Si Young Park', majors: '디지털인문예술 전공 20' },
    ],
  },
  {
    year: 2021,
    ...
    name: 'DEAR',
    title: '제3대 학생회 DEAR',
    titleEn: '2021 3rd Student Council DEAR',
    intro:
    ...
    members: [
      { role: '학회장', name: '안유미', nameEn: 'Yu Mi An', majors: '디지털미디어콘텐츠18' },
      { role: '부학회장', name: '오소민', nameEn: 'So Min Oh', majors: '광고홍보19' },
      { role: '기획국장', name: '오유진', nameEn: 'Yu Jin Oh', majors: '광고홍보19' },
      { role: '홍보국장', name: '박민주', nameEn: 'Min Ju Park', majors: '광고홍보19' },
    ],
  },
  {
    year: 2020,
    ...
    titleEn: '2020 2nd Student Council HARMONIES',
    intro:
    ...
    members: [
      { role: '학회장', name: '김도경', nameEn: 'Do Kyung Kim' },
      { role: '부학회장', name: '정예찬', nameEn: 'Ye Chan Jeong' },
      { role: '기획국장', name: '유이상', nameEn: 'Yi Sang Yoo' },
      { role: '총무국장', name: '이나라', nameEn: 'Na Ra Lee' },
      { role: '홍보국장', name: '최단비', nameEn: 'Dan Bi Choi' },
      { role: '기획부장', name: '윤호용', nameEn: 'Ho Yong Yoon' },
    ],
  },
  {
    year: 2019,
    ...
    titleEn: '2019 1st Student Council Curtain Up',
    intro: null,
    members: [
      { role: '회장', name: '송채원', nameEn: 'Chae Won Song' },
      { role: '부회장', name: '박재정', nameEn: 'Jae Jeong Park' },
    ],
  },
  {
    year: 2018,
    ...
    name: null,
    title: '임시학생회',
    titleEn: '2018 Interim Student Council',
    intro: null,
    members: [
      { role: '회장', name: '주영훈', nameEn: 'Young Hoon Ju' },
      { role: '부회장', name: '김도경', nameEn: 'Do Kyung Kim' },
    ],
  },
  {
    year: 2017,
    ...
    name: null,
    title: '임시학생회',
    titleEn: '2017 Interim Student Council',
    intro: null,
    members: [
      { role: '회장', name: '신소령', nameEn: 'So Ryeong Shin' },
      { role: '부회장', name: '이해솔', nameEn: 'Hae Sol Lee' },
    ],
  },
];
