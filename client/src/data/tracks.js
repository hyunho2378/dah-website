...
export const tracks = [
  {
    ...
    name: '디자인 트랙',
    summary:
      '디자인 트랙은 인문사회학의 토대 위에 디지털 기술과 디자인을 결합하여 미래의 경험을 창안하는 미래 디자인을 추구합니다. 경험 디자인, 사회혁신디자인, AI디자인을 3대 미래 디자인으로 규정하여 중점적으로 다루며 디자인의 기초 역량을 다지는 차원에서 디지털 디자인 교육을 병행합니다.',
    keywords: ['경험 디자인', '사회혁신디자인', 'AI디자인'],
    // H4.3 EN 대역
    summaryEn:
      "The Design Track pursues future design that creates tomorrow's experiences by combining digital technology and design on a humanities and social sciences foundation. It focuses on experience design, social innovation design, and AI design as the three pillars of future design, alongside digital design education that builds core design skills.",
  ...
  },
  {
    ...
    name: '엔터컬쳐 트랙',
    summary:
      '엔터컬쳐 트랙은 디지털 기술과 문화예술의 융합을 기반으로 한 창의적인 콘텐츠의 기획과 개발을 추구합니다. 디지털 콘텐츠의 본질을 이해하고 디지털 기술을 활용한 혁신적인 문화·예술 콘텐츠를 창안하는데 중점을 두며, 콘텐츠 기획 및 분석에 있어 인문학적 기반의 견고한 이론 지식과 디지털 기술을 활용한 새로운 표현의 가능성을 탐구합니다.',
    keywords: ['콘텐츠 기획', '문화예술', '디지털 기술'],
    summaryEn:
      'The Enter-Culture Track pursues the planning and development of creative content grounded in the convergence of digital technology and the arts. It focuses on understanding the nature of digital content and creating innovative cultural and artistic content with digital technology, exploring solid humanities-based theory and new expressive possibilities.',
