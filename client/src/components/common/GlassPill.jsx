// 11_DESIGN_V2 5절 GlassPill — 캡슐형 글래스 표면(rounded-sm)
...
function GlassPill({ as: Tag = 'div', className = '', children, ...rest }) {
  return (
    <Tag
      className={`inline-flex items-center rounded-sm border border-glass-line bg-glass-bg backdrop-blur-glass-mobile md:backdrop-blur-glass ${className}`}
      {...rest}
    >
      {children}
    </Tag>
